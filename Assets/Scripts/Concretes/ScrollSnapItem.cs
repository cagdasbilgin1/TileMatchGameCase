...
/// <summary>
/// Represents animatable item in the <see cref="ScrollSnapBehaviour"/>. 
...
public class FAScrollSnapItem : MonoBehaviour
{
    ...
    /// <summary>
    /// Handler for the <see cref="ScrollSnapBehaviour.onScrolled"/> event, that is responsible for animating this instance.
    /// </summary>
...
{
    /// <summary>
    /// Gets or sets the calculated anchoredPosition of the <see cref="ScrollSnapBehaviour"/>'s content, where the item is considered selected.
    /// </summary>
